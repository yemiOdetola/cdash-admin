...
export class MyChangeStatusDialogComponent implements OnInit {
	...
	form: FormGroup;
	statuses = ['In Progress', 'Stucked', 'Cancelled', 'Completed'];
	injectedData;
	/**
	 * Component constructor
	 *
	 * @param dialogRef: MatDialogRef<MyChangeStatusDialogComponent>
	 * @param data: any
	 * @param store: Store<AppState>
	 */
	constructor(
		private dialogRef: MatDialogRef<MyChangeStatusDialogComponent>,
