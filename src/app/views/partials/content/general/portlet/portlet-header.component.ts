	...
	updateStickyPosition() {
		if (this.sticky) {
			Promise.resolve(null).then(() => {
				...
				// I commented out the subHeaderElement, so I'll be using the head offset for the subhead
				const subheaderElement = <HTMLElement>document.querySelector('.kt-header');
